...
class CharacterAppearance {
    ...
    async init(id) {
        ...
        await conn.query(`INSERT INTO charactersappearanceparts SELECT ${this.id}, MIN(idAppearance) FROM appearances WHERE idAppearanceType IN (1,2,3,4,5,7,9,10) GROUP BY idAppearanceType`);
        await this.load(id);
    }
