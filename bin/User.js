    ...
    */
    ...
    async apiInfoPanel() {
        let infos = {
            ...
            attributesResults: {
                criticalHitChance: this.character.getCriticalHitChance(),
                magicalCriticalEvasionRate: this.character.getMagicalCriticalEvasionRate(),
                magicalCriticalRate: this.character.getMagicalCriticalRate(),
                magicalDefense: this.character.getMagicalDefense(),
                physicalCriticalEvasionRate: this.character.getPhysicalCriticalEvasionRate(),
                physicalCriticalRate: this.character.getPhysicalCriticalRate(),
                physicalDefense: this.character.getPhysicalDefense(),
            },
