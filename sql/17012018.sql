...
START TRANSACTION;
USE `discord_bot_rpg`;
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (1, 60);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (2, 74);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (3, 112);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (4, 186);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (5, 308);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (6, 490);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (7, 744);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (8, 1082);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (9, 1516);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (10, 2058);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (11, 2720);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (12, 3514);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (13, 4452);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (14, 5546);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (15, 6808);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (16, 8250);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (17, 9884);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (18, 11722);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (19, 13776);
INSERT INTO `discord_bot_rpg`.`LevelsRequire` (`level`, `expNextLevel`) VALUES (20, 16058);
...
INSERT INTO `discord_bot_rpg`.`StatsMonstres` (`idMonstre`, `idStat`, `value`) VALUES (2, 3, 1);
